...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO smapunggur_nilai (id_siswa, mata_pelajaran, nilai) VALUES (%s, %s, %s)",
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="id_siswa" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Mata_pelajaran:</td>
      <td><input type="text" name="mata_pelajaran" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
